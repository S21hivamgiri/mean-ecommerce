...
- **7 Libraries**
  ...
  - `@myCommerce/shop-feature-products` - Product listing feature (React)
  - `@myCommerce/shop-feature-product-detail` - Product detail feature (React)
  - `@myCommerce/shop-data` - Data access layer for shop features
  - `@myCommerce/shop-shared-ui` - Shared UI components
  - `@myCommerce/models` - Shared data models
  - `@myCommerce/api-products` - API product service library
  - `@myCommerce/shared-test-utils` - Shared testing utilities
...
npx nx run @myCommerce/shop:serve

# ...or you can serve the API separately
npx nx run @myCommerce/api:serve
...
# Run e2e tests
npx nx run @myCommerce/shop-e2e:e2e
...
npx nx show project @myCommerce/shop --web
```
...
npx nx run @myCommerce/shop-e2e:e2e-ci
```
...
npx nx run @myCommerce/shop-data:test
...
npx nx show project @myCommerce/shop --web                 # View project details

# Development
npx nx run @myCommerce/shop:serve                              # Serve React app
npx nx run @myCommerce/api:serve                               # Serve backend API
npx nx run @myCommerce/shop:build                              # Build React app
npx nx run @myCommerce/shop-data:test                          # Test a specific library
npx nx run @myCommerce/shop-feature-products:lint              # Lint a specific library
